<div ng-controller="searchController" layout="column">
    ...
    <div id="results" layout="row" layout-align="center center" ng-show="searched">
        ...
        <div layout="row" layout-align="center center" ng-hide="results.length == 0 || loading" layout-wrap>
            ...
            <table cellspacing="0" id="result_table">
